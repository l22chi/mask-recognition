...
Positive images were annotated with OpenCV (version 4.5.5, but works on 3.4.0 which is thee version required on this project) and the opencv_annotation tool (using a GUI).
